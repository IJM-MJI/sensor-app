...
시트에서 먼저 아래 항목만 사람 판정을 받는다.

- `1_90_H2_only_4` 30초가 정말 full 2% 반응인지
- `1_90_H2_only_test_3` 28초와 `1_90_H2_only_test` 30초가 full 3% 반응인지
- `1_90_H2O_only_2_extract`의 35초와 72초 사이 물방울 색이 실제로 충분히 변하는지
